...
const PaymentPage = ({ username }) => {
    ...
    useEffect(() => {
        ...
        // ensure username and router are stable
        ...
        <>
            ...
            <div className='cover w-full bg-red-50 relative'>
                {currentUser.coverpic ? (
                  <Image className='object-cover' src={currentUser.coverpic} alt="cover" width={1200} height={350} unoptimized />
                ) : (
                  <div className='w-full h-48 md:h-[350px] bg-gray-300' />
                )}
                <div className='absolute -bottom-20 right-[33%] md:right-[46%] border-white overflow-hidden border-2 rounded-full'>
                    {currentUser.profilepic ? (
                      <Image className='rounded-full object-cover' width={128} height={128} src={currentUser.profilepic} alt="profile" unoptimized />
                    ) : (
                      <div style={{width:128,height:128}} className='rounded-full bg-slate-700' />
                    )}
                </div>
            </div>
                        ...
                        <ul className='mx-5 text-lg'>
                            ...
                            {payments.map((p, i) => {
                                return <li key={i} className='my-4 flex gap-2 items-center'>
                                    <Image src="/avatar.gif" alt="user avatar" width={33} height={33} unoptimized />
                                    <span>
